function SecPaperSSIM(cover_image, watermark_logo, cover_image_filename)

    % Initialize a structure to store SSIM values
    results = struct('Attack', {}, 'WatermarkSize', [], 'SSIM', []);
    ...
    excel_filename = 'SSIM_Results.xlsx';
