function SecPaperNC(cover_image, watermark_logo, cover_image_filename)

    % Initialize a structure to store NC values
    results = struct('Attack', {}, 'WatermarkSize', [], 'NC', []);
    ...
    for attackIndex = 1:length(attacks)
        ...
        for watermark_size = watermark_sizes
            ...
            % Calculate NC
            NC = nc(watermarked_image, cover_image);
    ...
    excel_filename = 'NC_Results.xlsx';
